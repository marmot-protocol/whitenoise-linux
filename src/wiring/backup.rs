...
pub(crate) fn wire_backup(ui: &WhiteNoiseLinux, cx: &Cx, h: &Handlers) {
    ...
    wire!(ui, on_storage_create_backup [], |ui| {
    ...
    wire!(ui, on_create_backup_dismissed [], |ui| {
        ...
        move |password| {
            ...
            std::thread::spawn(move || {
                ...
                let Some(dest) = dest else {
                    ...
                    ui_update!(weak, move |ui| ui.set_create_backup_busy(false));
                    return;
                };
    ...
    wire!(ui, on_storage_backup_written [settings_cell], |ui, dest| {
        {
    ...
    wire!(ui, on_storage_import_backup [], |ui| {
    ...
    wire!(ui, on_import_backup_dismissed [], |ui| {
    ...
    ui.global::<AppState>().on_storage_clear_cache({
        ...
        move || {
            ...
            std::thread::spawn(move || {
                media_cache::clear();
                ui_update!(weak, move |ui| ui.set_storage_clearing(false));
